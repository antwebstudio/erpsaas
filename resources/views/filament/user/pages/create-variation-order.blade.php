<x-filament-panels::page>
    <div x-data="voWizard(@js($data))" class="w-full mx-auto border border-gray-200 dark:border-gray-700 shadow-sm bg-white dark:bg-gray-900 text-gray-950 dark:text-white rounded-xl" style="padding-bottom: 5rem;" x-cloak>

        <!-- Header -->
        <div class="border-b border-gray-200 dark:border-gray-700 p-6 flex justify-between items-end">
            <div>
                <h1 class="text-2xl font-bold uppercase tracking-tighter">Variation Order Builder</h1>
        ...
        <div class="fixed bottom-0 left-0 right-0 border-t border-gray-200 dark:border-gray-700 p-4 bg-white dark:bg-gray-900 shadow-lg z-50">
            <div class="w-full mx-auto">
                ...
                <div x-show="step === 1" class="flex justify-between">
                    ...
                    <button @click="submitVariationOrder"
    ...
    function voWizard(initialData) {
        return {
            ...
            get urlHasClient() {
                ...
                return urlParams.has('client') || urlParams.has('variation_order_id');
            },

            get currentStepLabel() {
                return ['Client Selection', 'Scope Selection'][this.step] || 'Variation Order Builder';
            },
