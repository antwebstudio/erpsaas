...
class AllClientPolicy
{
    ...
    {
        return $user->can('view_any_sales::all::client') || $user->can('view_mine_sales::all::client');
    }
    ...
    {
        if ($user->can('view_sales::all::client')) {
            return true;
        }

        if ($user->can('view_mine_sales::all::client') && $model->created_by === $user->id) {
            return true;
        }
