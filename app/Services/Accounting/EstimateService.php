        ...
        DB::transaction(function () use ($estimate, $data) {
            ...
            if ($client) {
                ...
                if (isset($data['client_name'])) {
                    $clientUpdate['name'] = $data['client_name'];
                }
                if (isset($data['client_nric'])) {
                    $clientUpdate['nric'] = $data['client_nric'];
                }
                ...
                if (isset($data['client_phone']) || isset($data['client_email'])) {
                    ...
                    if (isset($data['client_email'])) {
                        $contactUpdate['email'] = $data['client_email'];
                    }
                ...
                if (isset($data['client_address_line_1']) || isset($data['client_postal_code'])) {
                    ...
                    $addressUpdate = [];
                    if (isset($data['client_address_line_1'])) {
                        $addressUpdate['address_line_1'] = $data['client_address_line_1'];
                    }
                    if (isset($data['client_address_line_2'])) {
                        $addressUpdate['address_line_2'] = $data['client_address_line_2'];
                    }
                    if (isset($data['client_postal_code'])) {
                        $addressUpdate['postal_code'] = $data['client_postal_code'];
                    }
                    if (isset($data['client_country_code'])) {
                        $addressUpdate['country_code'] = $data['client_country_code'];
                    }
            ...
            if (isset($data['salesperson_name']) || isset($data['salesperson_email'])) {
                ...
                if ($createdBy) {
                    $userUpdate = [];
                    if (isset($data['salesperson_name'])) {
                        $userUpdate['name'] = $data['salesperson_name'];
                    }
                    if (isset($data['salesperson_email'])) {
                        $userUpdate['email'] = $data['salesperson_email'];
                    }
